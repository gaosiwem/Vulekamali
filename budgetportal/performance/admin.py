...
def save_imported_indicators(obj_id):
    ...
    for department, government_name in department_government_pairs:
        ...
        if alias_obj:
            models.Indicator.objects.filter(
                department=alias_obj.department).delete()
    ...
    for indicator_data in parsed_data:
        ...
        if department_obj:
            models.Indicator.objects.create(
                ...
                annual_national_comments=indicator_data.get(
                    "National_Summary", ""),
                annual_dpme_coordinator_comments=indicator_data.get(
                    "OTP_Summary", ""),
                annual_treasury_comments=indicator_data.get(
                    "National_Summary", ""),
